...
_0x3:
; 0000 0088       {
; 0000 0089        int LED[10] = {0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x01, 0x02};
; 0000 008A        int i = 0;
...
_0xB:
; 0000 008E               {
; 0000 008F                  PORTC = PORTD = 0x00;
	LDI  R30,LOW(0)
	OUT  0x12,R30
	OUT  0x15,R30
; 0000 0090                  PORTA = PORTB = LED[i];
	RCALL SUBOPT_0x0
	OUT  0x18,R30
	OUT  0x1B,R30
; 0000 0091                  delay_ms(150);
	RJMP _0xF
; 0000 0092               }
; 0000 0093               else
_0xA:
; 0000 0094               {
; 0000 0095                  PORTA = PORTB = 0x00;
	LDI  R30,LOW(0)
	OUT  0x18,R30
	OUT  0x1B,R30
; 0000 0096                  PORTC = PORTD = LED[i];
	RCALL SUBOPT_0x0
	OUT  0x12,R30
	OUT  0x15,R30
; 0000 0097                  delay_ms(150);
_0xF:
	LDI  R26,LOW(150)
	LDI  R27,0
	CALL _delay_ms
