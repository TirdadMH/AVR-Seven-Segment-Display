...
_0x3:
; 0000 0088       {
; 0000 0089        PORTC = 0x76;
	LDI  R30,LOW(118)
	OUT  0x15,R30
; 0000 008A        PORTD = 0x79;
	LDI  R30,LOW(121)
	OUT  0x12,R30
; 0000 008B        PORTB = 0x38;
	LDI  R30,LOW(56)
	OUT  0x18,R30
; 0000 008C        PORTA = 0x3F;
	LDI  R30,LOW(63)
	RCALL SUBOPT_0x0
; 0000 008D        delay_ms(1500);
; 0000 008E        PORTA = PORTB = PORTC = PORTD = 0x00;
	RCALL SUBOPT_0x1
; 0000 008F        delay_ms(1500);
; 0000 0090        PORTB = 0x38;
	LDI  R30,LOW(56)
	OUT  0x18,R30
; 0000 0091        PORTD = 0x77;
	LDI  R30,LOW(119)
	OUT  0x12,R30
; 0000 0092        PORTA = PORTC = 0x40;
	LDI  R30,LOW(64)
	OUT  0x15,R30
	RCALL SUBOPT_0x0
; 0000 0093        delay_ms(1500);
; 0000 0094        PORTA = PORTB = PORTC = PORTD = 0x00;
	RCALL SUBOPT_0x1
; 0000 0095        delay_ms(1500);
; 0000 0096        PORTD = 0x7D;
	LDI  R30,LOW(125)
	OUT  0x12,R30
; 0000 0097        PORTB = 0x3F;
	LDI  R30,LOW(63)
	OUT  0x18,R30
; 0000 0098        PORTA = 0x5E;
	LDI  R30,LOW(94)
	OUT  0x1B,R30
; 0000 0099        PORTC = 0x40;
	LDI  R30,LOW(64)
	OUT  0x15,R30
; 0000 009A        delay_ms(1500);
	LDI  R26,LOW(1500)
	LDI  R27,HIGH(1500)
	CALL _delay_ms
; 0000 009B        PORTA = PORTB = PORTC = PORTD = 0x00;
	RCALL SUBOPT_0x1
; 0000 009C        delay_ms(1500);
; 0000 009D       }
	RJMP _0x3
; 0000 009E }
_0x6:
